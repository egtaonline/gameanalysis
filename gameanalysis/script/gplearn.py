...
def add_parser(subparsers):
    parser = subparsers.add_parser(
        'gplearn', help="""Learn a gp model""", description="""Learn a gp
        model""")
    parser.add_argument(
        ...
        stdin)""")
    parser.add_argument(
        '--output', '-o', metavar='<output-file>', default=sys.stdout.buffer,
        type=argparse.FileType('wb'), help="""Output file for script. (default:
        stdout)""")
    return parser
